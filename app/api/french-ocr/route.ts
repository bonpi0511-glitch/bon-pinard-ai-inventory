...
会話練習の教材として使うために、写真に写っているフランス語の内容（会話文、語彙リスト「Vocabulaire」、決まり文句「Manières de dire」、文法説明の例文など）をできるだけ正確にテキストとして書き起こしてください。
チェックボックスの番号、空欄穴埋め問題の下線、正誤問題の指示文など、練習問題そのものの指示や記号は省略してよいですが、会話文・語彙・例文は省略せずすべて書き起こしてください。
